...
from video2png import cutVideo
...
out_nii_dir = '/home/sjy/Documents/data/labelsTr/'
...
for json_file in json_files:
    ...
    png_path = os.path.join(image_dir, file_name)

    video_path = os.path.join(videos_dir, file_name) + '.avi'
    cutVideo(video_path, la_idx, png_path)
    #    print(len(la_idx))
