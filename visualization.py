...
def plot_overlay(image_file: str, segmentation_file: str, output_file: str, overlay_intensity: float = 0.3):
...
# img_path = '/nvme/train_npz/tr_image/oct_8 Jul 2021 02-12-10_23_0000.nii.gz'
# seg_path = '/nvme/train_npz/tr_label/oct_8 Jul 2021 02-12-10_23.nii.gz'
